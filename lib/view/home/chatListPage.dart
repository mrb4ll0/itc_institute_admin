  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            // STATIC SEARCH BAR (Always visible at top)
            Padding(
            ...
            // SCROLLABLE CONTENT (Everything below search bar)
            Expanded(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: isDark ? Colors.white : const Color(0xFF23243a),
                                  fontSize: 15,
                                ),
                              ),
                            ),
                        ...
                        if (messages.isEmpty) {
                          ...
                          return FutureBuilder<List<Student>>(
                            ...
                            builder: (context, studentSnap) {
                              ...
                              if (students.isEmpty) {
                                return const Center(
                                    child: Text("No other students registered yet."));
                              }
